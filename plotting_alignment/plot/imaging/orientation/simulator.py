...
"""
aplt.plot_array(array=dataset.data, output_path=dataset_path, output_format="png")
aplt.subplot_tracer(
    tracer=tracer, grid=grid.binned, output_path=dataset_path, output_format="png"
)
