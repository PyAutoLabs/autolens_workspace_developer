...
dict_path = (
    results_dir
    / f"delaunay_knn_barycentric_likelihood_summary_{instrument}_v{al_version}.json"
)
...
chart_path = (
    results_dir
    / f"delaunay_knn_barycentric_likelihood_summary_{instrument}_v{al_version}.png"
)
...
DELAUNAY_HST_REFERENCE = (
    26288.321397232066  # Delaunay value at same fiducial (from delaunay.py)
)
...
print(
    f"  Absolute difference:         {float(log_evidence_ref) - DELAUNAY_HST_REFERENCE:+.4f}"
)
