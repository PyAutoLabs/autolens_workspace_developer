"""
Minimal probe: does the mapping matrix of a RectangularBilinearAdaptDensity mapper
...
# because RectangularBilinearAdaptDensity rebuilds it inside interpolator_from.
