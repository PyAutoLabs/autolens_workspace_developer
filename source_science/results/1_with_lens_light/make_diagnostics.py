...
# Must match fit_compare.py for the v3 cache to resume.
...
def main():
    ...
    ax.set_title("Test 1 — Source radial profile (with lens light)")
    ...
    ax.set_title("Test 1 — Cumulative source flux (with lens light)")
