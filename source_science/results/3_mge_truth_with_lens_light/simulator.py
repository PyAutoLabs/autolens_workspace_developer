"""
Simulator: MGE source truth, WITH lens light.

Same lens setup as test 1 (`results/1_with_lens_light/simulator.py`) — Sersic
bulge + SIE + shear — but the source is the MGE galaxy extracted from the
test-2 mge_source fit (see `source_science/extract_mge_truth.py`,
saved to `source_science/results/mge_truth_source.json`).
...
"""
__Truth source-science quantities__
"""
